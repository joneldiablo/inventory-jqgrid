/**
 * @license jqGrid Spanish Mexico Translation
 * Traduccion jqGrid en Español por Yamil Bracho editado jon_eldiablo
 *
...
(function(factory) {
    ...
    var locInfo = {
        ...
        search: {
            ...
            groupOps: [
                { op: "AND", text: "Todas las condiciones" },
                { op: "OR", text: "Alguna de las condiciones" }
            ],
    ...
    $.extend(true, $.jgrid, {
        ...
        locales: {
            ...
            "es-MX": $.extend({}, locInfo, { name: "Español (México)", nameEnglish: "Spanish (Mexico)" })
        }
    });
}));